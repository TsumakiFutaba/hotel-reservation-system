...
<!-- Palitan nyo na lang to ng title ng hotel naten !-->
    <title>Hotel Title - About Us</title>
    ...
    <div class="row justify-content-between align-items-center">
      <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
        ...
        <p>
          ...
          Consequatur doloremque dolor possimus assumenda nam id quos aspernatur veniam tenetur, 
          unde sit dolorum corrupti quis sunt nulla quisquam tempore quaerat pariatur?
        </p>
      </div>
