   ...
   <div class="modal-content">
     <form>
       ...
       <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
         Note: Please double check if the details that you have in your ID (Nation ID, Passport, Driver's License, etc.) 
         match in the registration form that will be required during check-in.
       </span>
       <div class="container-fluid">
         <div class="row">
           ...
           <div class="col-md-6 ps-0 mb-3">
             <label class="form-label">Password</label>
             <input type="pasword" class="form-control shadow-none">
           </div>
           <div class="col-md-6 ps-0 mb-3">
