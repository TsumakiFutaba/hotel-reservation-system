        ...
        <div class="bg-white rounded shadow p-4">
          <form method="POST">
            ...
            <div class="mb-3">
              ...
              <input name="email" class="form-control shadow-none" required>
            </div>
            <div class="mb-3">
              <label class="form-label" style="font-weight: 500">Subject</label>
              <input name="subject" class="form-control shadow-none" required>
            </div>
            <div class="mb-3">
              <label class="form-label" style="font-weight: 500">Message</label>
              <textarea name="message" class="form-control shadow-none" rows="1" required></textarea>
            </div>
